...
results = mlp.backpropagation(model, x, y, eta = 0.1, 
                          threshold = 1e-3, max_epochs = 40000)
...
xor.predict <- function(x, y, results){
...
results = mlp.backpropagation(model, x.train = x, y.train = y, eta = 0.05, 
                        threshold = 1e-4, max_epochs = 50000)
...
iris.test = mlp.test(x.train = sets$x.train, y.train = sets$y.train, 
                     ...
                     eta = 0.1, threshold = 1e-2, max_epochs = 20000)
...
# $y.prob
# [,1]       [,2]         [,3]
# [1,] 0.9912373261 0.02668092 3.417284e-05
# [2,] 0.9910310378 0.02755559 3.429463e-05
# [3,] 0.9907441917 0.02880382 3.447329e-05
# [4,] 0.9912956462 0.02643358 3.413700e-05
# [5,] 0.9914008851 0.02594957 3.404374e-05
# [6,] 0.9916309625 0.02496283 3.388220e-05
# [7,] 0.9919699317 0.02346401 3.358693e-05
# [8,] 0.9917390767 0.02448384 3.379071e-05
# [9,] 0.9914161246 0.02590134 3.404568e-05
# [10,] 0.9917375326 0.02448260 3.378596e-05
# [11,] 0.9908254602 0.02845773 3.442913e-05
# [12,] 0.9915620428 0.02525301 3.392783e-05
# [13,] 0.9919430772 0.02358660 3.361449e-05
# [14,] 0.9912956462 0.02643358 3.413700e-05
# [15,] 0.9917459873 0.02446202 3.379138e-05
# [16,] 0.9912956462 0.02643358 3.413700e-05
# [17,] 0.9917931374 0.02424711 3.374591e-05
# [18,] 0.0082431089 0.99949390 1.499775e-04
# [19,] 0.0034564150 0.99613132 3.466000e-03
# [20,] 0.0034097197 0.99252243 4.006163e-03
# [21,] 0.0042384262 0.99366973 1.917596e-03
# [22,] 0.0043150539 0.99775572 1.575383e-03
# [23,] 0.0022382197 0.98738130 1.919669e-02
# [24,] 0.0015751500 0.78751731 8.358411e-02
# [25,] 0.0087877846 0.99955144 1.320095e-04
# [26,] 0.0064595612 0.99903689 4.090891e-04
# [27,] 0.0010420917 0.82245439 2.569065e-01
# [28,] 0.0055719356 0.99858064 7.186769e-04
# [29,] 0.0003045091 0.04070790 9.769061e-01
# [30,] 0.0013463347 0.65059595 1.450710e-01
# [31,] 0.0018291200 0.98129341 3.598675e-02
# [32,] 0.0049968949 0.99793379 9.630867e-04
# [33,] 0.0002761017 0.02953027 9.839667e-01
# [34,] 0.0002751102 0.02908969 9.841883e-01
# [35,] 0.0003078818 0.03785568 9.764080e-01
# [36,] 0.0003296091 0.05559412 9.687805e-01
# [37,] 0.0002880574 0.03254599 9.813150e-01
# [38,] 0.0002749652 0.02905002 9.842236e-01
# [39,] 0.0008166570 0.69561194 4.612716e-01
# [40,] 0.0002985148 0.04000754 9.782955e-01
# [41,] 0.0006279591 0.41489058 7.121442e-01
# [42,] 0.0002768588 0.02991793 9.837814e-01
# [43,] 0.0002787022 0.02993825 9.834751e-01
# [44,] 0.0002756526 0.02922578 9.840762e-01
# [45,] 0.0003438088 0.05007646 9.644385e-01
# 
# $y.pred
#       [,1] [,2] [,3]
# [1,]    1    0    0
