...
#brechmarking: análise da convergência -> treinamento (backpropagation)
...
#brechmarking: análise de #neurônios hidden layer -> teste
mlp.hidden.brechmark <- function(x, y, min.hidden, max.hidden, 
  ...
  plot(acuracies[, 1], acuracies[, 2], type = 'l', 
       main = 'Brenchmark of Hidden Layer', xlab = '#neurônios hidden',
       ylab = 'acurácia')
